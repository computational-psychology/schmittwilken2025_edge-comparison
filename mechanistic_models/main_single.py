...
####################################
results_dir = "./results/"
results_file = "active_multi.pickle"
...
#           Preparations           #
####################################
logname = "log_" + results_file.rsplit(".")[0] + ".txt"
...
if __name__ == "__main__":
    ...
    params_dict = {
        ...
        "eta": np.linspace(0., 1.2, 7),
        "kappa": np.linspace(0., 10., 6),
        "alpha": np.linspace(0., 3, 7),
        }
    ...
    bparams, bloss = grid_optimize(results_dir + results_file, params_dict, get_loss, adict)
    ...
    if automatic_grid:
        ...
        with open(results_dir + results_file, 'rb') as handle:
        ...
        with open(results_dir + results_file, 'wb') as handle:
